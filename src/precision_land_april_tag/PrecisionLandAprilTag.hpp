...
class PrecisionLandAprilTag : public px4_ros2::ModeBase
{
public:
	explicit PrecisionLandAprilTag(rclcpp::Node& node);

	void targetPoseCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
	void vehicleLandDetectedCallback(const px4_msgs::msg::VehicleLandDetected::SharedPtr msg);
	void detectionsCallback(const tf2_msgs::msg::TFMessage msg);
